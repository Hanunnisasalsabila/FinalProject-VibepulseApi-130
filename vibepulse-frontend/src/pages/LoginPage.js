...
import { FaMusic, FaUser, FaLock, FaEye, FaEyeSlash } from 'react-icons/fa';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a1033] via-[#0f172a] to-[#020617] flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="mt-2 text-purple-200 text-lg">Welcome back to midnight music ✨</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 animate-slide-in">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/50 transition-all"
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-12 pr-12 py-3 bg-white/5 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/50 transition-all"
          ...
          <div className="mt-6 text-center">
            <p className="text-purple-200">
              ...
              <Link to="/register" className="text-purple-300 font-semibold hover:text-white transition-colors relative group">
                Sign up now
        ...
        <div className="absolute -bottom-20 -left-20 text-9xl text-purple-500/10 animate-float pointer-events-none">♪</div>
        <div className="absolute -top-20 -right-20 text-7xl text-purple-500/10 animate-float pointer-events-none" style={{ animationDelay: '1s' }}>♫</div>
      </div>
